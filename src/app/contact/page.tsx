        ...
        <div className="container mx-auto px-6 lg:px-14">
          ...
          <div className="mb-10">
            <h1 className="text-3xl md:text-4xl font-extrabold text-[#2d1070]">
              Get in Touch with TyrePro for Expert Automotive Services
            </h1>
            <p className="mt-3 max-w-4xl">
              ...
              Whether you have a question about our services, want to schedule
              an appointment, or simply need advice on maintaining your vehicle,
              we&apos;re here to help. At TyrePro, our team of experienced
              professionals is dedicated to providing you with the highest level
              of service and support. Feel free to reach out to us via phone,
              email, or by filling out the contact form below. We look forward
              to assisting you with all your automotive needs.
            </p>
          </div>
